...
If you want to try fish but want to have a fallback to your old workflow, you can use the following 
trick: Let assume without loss of generality that your default shell is bash. Just add ``fish`` at 
the end of your ``.bashrc`` file. Then, when you open a new terminal, you will be in fish. If you 
want to go back to bash, press ``Ctrl-D``. 

Using this approach, configurations from your ``.bashrc`` will be  inherited by fish.
